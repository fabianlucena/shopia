...
public static class Setup
{
    ...
    public static async Task ConfigureShopiaAsync()
    {
        ...
        var basePlan = await PlanService.GetSingleOrCreateByNameAsync("Base", createFactory: async plan => {
            plan.Description = "Plan inicial gratuito para todos los nuevos usuarios";
            return plan;
        });
        ...
        foreach (var limit in limits)
        {
            ...
            await PlanLimitService.GetSingleOrCreateByNameAsync(limit.Name, createFactory: async limit => {
                limit.PlanId = basePlanId;
                return limit;
            });
        }
        ...
        {
            await CategoryService.GetSingleOrCreateByNameAsync(kv.Key, createFactory: async category => {
                category.Description = kv.Value;
                return category;
            });
        }
    }*/
